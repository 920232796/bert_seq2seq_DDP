...
model_save_dir = "./state_dict/bert_semantic_matching/"
batch_size = 16
lr = 1e-5
# 加载字典
...
trainer = Trainer(epoches=3, val_every_step=100, batch_size=16, env_type="pytorch",
...
def main():
    ...
    val_dataset = SemanticMatchingDataset(val_input, val_label)
